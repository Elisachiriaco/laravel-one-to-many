...
<form action="{{route('admin.posts.update',$post->id)}}" method="POST">
    ...
    @method('PUT')
      <div class="mb-3">
        ...
        name="title" value="{{old('title',$post->title)}}" placeholder="Inserisci un titolo">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select name="category_id" id="category" class="form-control @error('category_id') is-invalid 
        @enderror">
